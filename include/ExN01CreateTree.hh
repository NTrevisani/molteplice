...
*/
  ...
  int number_0;
  float depositedEnergyTotal_0 ;
  std::vector<float> * depositedEnergies_0 ;

  int number_3;
  float depositedEnergyTotal_3 ;
  std::vector<float> * depositedEnergies_3 ;

  int number_10;  
  float depositedEnergyTotal_10 ;
  std::vector<float> * depositedEnergies_10 ;
  
  int number_30;  
  float depositedEnergyTotal_30 ;
  std::vector<float> * depositedEnergies_30 ;
  
  int number_100;  
  float depositedEnergyTotal_100 ;
  std::vector<float> * depositedEnergies_100 ;
